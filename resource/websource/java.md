...
+ [大厂面试必问 Java 内部类详解](https://mp.weixin.qq.com/s/u-Tru204W3oAr8Zb35A_XQ)
...
+ [一文讲透 Java 基本类型、包装类和自动装箱拆箱](https://mp.weixin.qq.com/s/wwUI9waBEFRl1db9iWEqrA)
+ [类型转换：隐式、显式与类型提升](https://mp.weixin.qq.com/s/1DGpFUFnee8OrOHf_EzHGQ)
...
+ [面试必考！Java 数组高频知识点](https://mp.weixin.qq.com/s/09euN9SsHCvfLAl95Rqd6Q)
...
+ [Java可变参数的使用规范与限制](https://mp.weixin.qq.com/s/fq3OO_1F9hT_O54L2W6mfg)
...
+ [面试官问我try-with-resources，我用"自动关门"讲明白了](https://mp.weixin.qq.com/s/pg7Smx00Iybc-0NEwfL6QQ)
+ [如何理解 Java 的异常？](https://mp.weixin.qq.com/s/_Srept6chtSswwEkmquY8w)
...
+ [Java 枚举用法进阶：接口契约、反向查找、JSON/DB 互转、策略分派](https://mp.weixin.qq.com/s/JrfegmlnM1qicMH0mHg6-A)
...
+ [泛型和枚举用错了？《Effective Java》这 6 个技巧让代码少报错](https://mp.weixin.qq.com/s/1GCmqNCgOgiOd1tQh6ktSQ)
...
+ [Java泛型：T、E、K、V、?，你还在傻傻分不清？](https://mp.weixin.qq.com/s/5K99-5m_1EGE-mTPiAUbrw)
+ [面试官：什么是 Java 泛型？为什么要使用它？](https://mp.weixin.qq.com/s/XoU2i34O1XAPbar5XM5JNw)
+ [学Java泛型，看完这篇就够了](https://mp.weixin.qq.com/s/LConHTEy5wwZ679noBGv8w)
...
+ [类和对象 | Java语言关键](https://mp.weixin.qq.com/s/CvCvfMfUcb0NkdBQYr1Pmg)
...
+ [用好 Java 继承，精简项目冗余代码](https://mp.weixin.qq.com/s/ShvS2RDYmaKUTaZZiG6MVw)
+ [[Java设计模式] 第 2 课：接口 vs 抽象类 —— 面向接口编程](https://mp.weixin.qq.com/s/gQIOBz82PHa4YELz4SHSOQ)
...
+ [JDK 9 的 模块化 & jmod & 反射 & ClassLoader & JShell](https://mp.weixin.qq.com/s/YsZrhL2VQOrC_kFbhhsrMQ)
...
+ [JDK 8钉子户的自我进阶：终于升级到JDK 21了！](https://mp.weixin.qq.com/s/5YPy_aeTZ0MoaGzDvkUq5A)
...
+ [JDK 27 又把 API 砍了俩方法，JEP 531 和 Set.ofLazy() 来了](https://mp.weixin.qq.com/s/dy_1S007f9aNtCkOZSPlLw)
+ [Java 接口默认方法与静态方法：从 Java 8 开始的接口进化](https://mp.weixin.qq.com/s/EuU35xmKRFKympyJtMch2g)
+ [Java 瓦尔哈拉项目登陆 JDK 28，推出值类型预览版](https://mp.weixin.qq.com/s/5l8HmBpJZI3KcITHaYlY-Q)
+ [Record 和 Lombok @Data 看着一样,语义上完全是两回事](https://mp.weixin.qq.com/s/j4ljHEmbvCXuky1gWEMuLw)
+ [JDK 27，从 JEP 338 到 JEP 537 一个性能提升 16 倍的 API](https://mp.weixin.qq.com/s/iikrasY8poCd-EQvF8-E4w)
+ [JDK17前后写法对比：差点没认出是Java！](https://mp.weixin.qq.com/s/oTYjvbV3__tXDJt6mRNoOg)
+ [Java 28 值类型预览：Project Valhalla 核心机制与代码实战](https://mp.weixin.qq.com/s/bdm6tnpRsr8M85Khs1HQbg)
+ [Java FFM API(Project Panama)（1）](https://mp.weixin.qq.com/s/8fBOJo2er0H1mN58XZft1Q)
+ [JAVA | 第28期 - 盘点 Java8 到 Java25 的变化](https://mp.weixin.qq.com/s/dHEr6yH-mQ3AAk7cwRcS3w)
...
+ [[Java多线程][异步编程] 第55课：Java 21虚拟线程入门](https://mp.weixin.qq.com/s/izOfvAlcNpMov043lXzWag)
...
+ [Java8中一个极其强悍的新接口，很多人没用过](https://mp.weixin.qq.com/s/QPw3d24i1TX97BRinLUaUA)
...
+ [推荐使用 try-with-resources 结合 HTTP 方便简洁安全](https://mp.weixin.qq.com/s/RMxVMEq0GbRMxSdKXyysjw)
...
+ [Lambda 详解与实战](https://mp.weixin.qq.com/s/CpDYo0T3UUcV8tEm2oAE8A)
...
+ [写 Java，这 13 个坑你中过几个？](https://mp.weixin.qq.com/s/QxuH_VU1vJDYqvJsaJBsZQ)
...
+ [6.2 Java 函数式接口（Functional Interface）](https://mp.weixin.qq.com/s/N9oM4rlb9DDwftQCfegLiw)
+ [原理——Java的运行机制、内存和内存地址、变量和方法的内存分配、数组的内存分配、数组在方法中传递](https://mp.weixin.qq.com/s/eg24gitI_RU6aacXnydX1A)
+ [认识fail-fast、fail-safe的性能影响](https://mp.weixin.qq.com/s/JJl1Ci0LFsrM8Y43t-x6aQ)
+ [Java 四种引用：强引用、软引用、弱引用与虚引用](https://mp.weixin.qq.com/s/-UhO5mXBab2-GT6vM1xlhg)
+ [Java 调优踩过的 5 个大坑：我熬了 3 个通宵才总结出的避坑指南](https://mp.weixin.qq.com/s/YMy1Qbl5RB1Zw0rc69Ekmg)
+ [面向对象原理——Java中对象的内存分配、对象在方法中进行传递、this关键字的本质](https://mp.weixin.qq.com/s/D1KIHPStrT341WuxKlSNNg)
+ [枚举类&注解、基本类型和包装类对象、泛型、IO流](https://mp.weixin.qq.com/s/zU_MEd7jZLDIFLsu4oFTIw)
+ [[讲透Java]List体系](https://mp.weixin.qq.com/s/GwETDG1M5slxtAbDxTLXYw)
+ [Java开发：深度解析同步与异步机制，优化程序性能核心指南](https://mp.weixin.qq.com/s/UHW6Xcrp4pGpBlbOqld09g)
+ [单例模式深度解析：六种写法的演进、DCL 的 volatile 陷阱，以及 Spring 单例和 GoF 单例根本不是一回事](https://mp.weixin.qq.com/s/PQvWtD9AQ13-Quz8YYpjJg)
+ [进击的 Java 28：从汇编级源码洞察硬件级加速](https://mp.weixin.qq.com/s/meu9pu0QrwMHEvo3UmNVlA)
+ [被问烂的 String，你真的懂吗？](https://mp.weixin.qq.com/s/f0ZTIGRSOkLoNH36t9Kvyg)
+ [面试官问我Comparable和Comparator有什么区别，我说了3点，他点点头](https://mp.weixin.qq.com/s/Olx_P86sB8EKf8cIjjLd9w)
+ [别再用BigDecimal算钱了！JavaMoney才是Java货币计算的正确姿势](https://mp.weixin.qq.com/s/O193FlOa6WViTdiI_Gjuug)
...
+ [面试官问我序列化，我用"快递打包"讲明白了](https://mp.weixin.qq.com/s/NA3O9biiKRGVoDb6OSCoAA)
...
+ [Java IO 三巨头：BIO、NIO、AIO 通俗拆解，小白也能懂的高并发选型指南](https://mp.weixin.qq.com/s/MRoTEIu_5qotcRtj26GiBw)
...
+ [9.2 Java 反射操作实战 · 构造器 · 字段 · 方法](https://mp.weixin.qq.com/s/gy3keRhFWHqjhNd1b7H_lQ)
+ [反射、泛型、注解、SPI、动态代理——Java高级特性实战解析](https://mp.weixin.qq.com/s/2-Lfm7LIAPUfHkhxRfRtUA)

### 并发/多线程

+ [并发编程 - 初识线程](https://mp.weixin.qq.com/s/BUwsqOcQ5m3MRnsRVwUuoQ)
+ [并发编程 - 线程浅试](https://mp.weixin.qq.com/s/mby0p8lVgHCM0VNZWm34bw)
+ [Java 线程基础：进程、线程、并发并行、创建方式与生命周期](https://mp.weixin.qq.com/s/KSpeBcN-HZTQpv9cbA--nQ)
...
+ [你还只会用锁？盘点 Java 实现线程安全的 7 种高效方案](https://mp.weixin.qq.com/s/JUC3WIrKlepvwGcJHAez8A)
...
+ [JMM、volatile 与 CAS：并发安全三大问题](https://mp.weixin.qq.com/s/RP85-6LMO0tT6C25ymPgWw)
...
+ [Java线程创建有哪几种方式？到底该怎么回答？](https://mp.weixin.qq.com/s/h2O_uDrfttdH5TJz4_Y0WQ)
+ [[Java多线程] 第10课：小项目——线程安全的银行转账](https://mp.weixin.qq.com/s/4DM_xYxzRF4D7Gb8FY1VnA)
+ [[Java多线程][底层原理] 第58课：JMM三大特性——原子性、可见性、有序性](https://mp.weixin.qq.com/s/LnzkyzRjeW1-amyYAQ2rIg)
+ [并发世界里的“先后关系”不是看时间(一文讲透Java Happens-Before规则)](https://mp.weixin.qq.com/s/815V5ZptIWynYQY-JuxCew)
+ [并发问题的“三件套”(一文讲透Java并发 原子性、可见性和有序性)](https://mp.weixin.qq.com/s/_FYR16E8SAHA1DjTIvMd9g)
+ [虚拟线程上了生产之后：我踩过的坑和调优实战](https://mp.weixin.qq.com/s/At8mwflwVFKgnvxt9Vr-aA)
+ [虚拟线程进阶：JDK 25升级后，上篇文章的坑还需要自己填吗？](https://mp.weixin.qq.com/s/vA2djnqg0ivGd8nFaMOG6Q)
+ [[Java多线程] 第6课：线程安全问题——三个线程卖100张票](https://mp.weixin.qq.com/s/IENAhoshr0a1dcw00N-EhQ)
+ [[Java多线程][异步编程] 第48课：Callable与Future——获取返回值](https://mp.weixin.qq.com/s/u75i_K6l-lNcqFhR4r6ZAg)
+ [Java 开发 > 一个系统两套线程模型 ThreadPoolExecutor + Virtual Thread，Java 并发的终局方案](https://mp.weixin.qq.com/s/cmNLhW7ubON8h1ERuY-wpA)
+ [线程不是“跑起来”就完事了（一文讲透Java 线程的生命周期）](https://mp.weixin.qq.com/s/97PAgYm9XGMpM5odcFzUoQ)
+ [[Java多线程][学习完结] 第79课：50道高频面试题](https://mp.weixin.qq.com/s/1qq6-PNnXAPtxAOAkNWTRA)
+ [[Java多线程][调优与排查] 第72课：常见并发Bug排查](https://mp.weixin.qq.com/s/flhSvt9nY2vHKYX4OKBzmA)
+ [[Java多线程] 第12课：notifyAll——虚假唤醒问题](https://mp.weixin.qq.com/s/xNbAJuYae3FuVifcrFl0iw)
+ [[Java多线程][设计模式] 第70课：中断模式](https://mp.weixin.qq.com/s/MchPieHL1omJxKc16C_WPA)
+ [[Java多线程][异步编程] 第57课：小项目——并行数据聚合服务](https://mp.weixin.qq.com/s/41ieRaIV82VQOBDMhXC2Tg)
+ [[Java多线程][综合实战] 第75课：高并发秒杀系统](https://mp.weixin.qq.com/s/GOf6BSxC7pxKLfnUFojJVQ)
+ [[Java多线程][原子类无锁并发] 第29课：小项目——高性能点赞计数器](https://mp.weixin.qq.com/s/Swrau4Z3E7Bnxo9CzQ6gQA)
+ [[Java多线程][异步编程] 第54课：Fork/Join框架与并行流](https://mp.weixin.qq.com/s/xa36iata4DWeayTlM3mbfA)
...
+ [并发编程-Atomic原子操作类&CAS](https://mp.weixin.qq.com/s/759cDYPr-j70feQeGuqvWg)
+ [面试必看 | 深度解析CAS：原理、应用及ABA问题全攻略](https://mp.weixin.qq.com/s/ALiwsXhiv7MEmyIh6fnGcg)
+ [JMM 进阶：彻底理解 CAS 实现原理](https://mp.weixin.qq.com/s/R3HX2bcKEM4ZMubrtXHLhA)
+ [[Java多线程][原子类无锁并发] 第25课：AtomicInteger/Long用法](https://mp.weixin.qq.com/s/rcI-R8C-WCIW63GTTH1fIQ)
+ [[Java多线程][原子类无锁并发] 第24课：CAS原理——比较并交换](https://mp.weixin.qq.com/s/31E9-yPXeKQRTxX6GXyjiQ)
...
+ [京东二面惨案：线程池还背N+1/2N？面试官：敢上线就等着背锅！](https://mp.weixin.qq.com/s/FnQlQDZJbMWbqJujplSY_Q)
...
+ [面试题库：线程池核心参数与工作原理](https://mp.weixin.qq.com/s/OZkOunezjhFbm0vmdr8Kuw)
+ [[Java多线程][线程池] 第30课：为什么需要线程池？](https://mp.weixin.qq.com/s/kcbxOZeMd3lB68vjDq_5VQ)
+ [[Java多线程][线程池] 第31课：ThreadPoolExecutor——七大参数详解](https://mp.weixin.qq.com/s/ya3d0wNjLKdQde15kllMPg)
+ [[Java多线程][线程池] 第32课：线程池工作流程——任务怎么进来？](https://mp.weixin.qq.com/s/4HQ6ZZN7YSJ-oxzeR-SyMg)
+ [[Java多线程][线程池] 第34课：Executors——四种预置线程池](https://mp.weixin.qq.com/s/BQVzeMMo6s0wM5teGSwPJA)
...
+ [synchronized从偏向锁到重量级锁：JVM锁升级全流程](https://mp.weixin.qq.com/s/WyCHycqnrWo5FUu3Jzsolw)
+ [Java 并发编程的核心同步框架-AQS](https://mp.weixin.qq.com/s/ZWvWWMt33rbcDD7ro8M5ew)
+ [面试官问我ReentrantLock和synchronized区别，我用"手动挡vs自动挡"讲明白了](https://mp.weixin.qq.com/s/MNlU-LEzcVgP7e7qdsbIbw)
+ [synchronized锁升级：从偏向锁到重量级锁，面试官都爱问的那道题](https://mp.weixin.qq.com/s/PhEIFUwDrwfM5jYpSiKEzA)
...
+ [更灵活，也更容易出错（一文讲透Java ReentrantLock）](https://mp.weixin.qq.com/s/EuoANc1zz_GhwencychVHA)
+ [搞懂AQS，Java并发包你就横着走](https://mp.weixin.qq.com/s/5Sinh55Gg_Hu6wEyP8WFIA)
+ [JUC 并发工具背后的“排队叫号系统”（一文讲透Java AQS）](https://mp.weixin.qq.com/s/QwPYfrslhU6Ypehveywdnw)
+ [AQS框架的现代理解：CLH队列变体、Condition与共享模式](https://mp.weixin.qq.com/s/01hQAL3tE0kzyS86NVVCeQ)
+ [[Java多线程] 第9课：死锁——两根筷子的故事](https://mp.weixin.qq.com/s/YSlGEk3fpzVJMpreRSHOpQ)
+ [两个线程各拿一把锁，为什么谁也走不了？（一文讲透Java 死锁）](https://mp.weixin.qq.com/s/XTTtVx8NiaKX6RnJ3M85DQ)
+ [不是不加锁，而是冲突了再处理（一文讲透Java的乐观锁）](https://mp.weixin.qq.com/s/kyn_6Yv42vlJM22XQOK2oA)
+ [[Java多线程][锁进阶] 第22课：锁升级——JDK 6 对 synchronized 的关键优化](https://mp.weixin.qq.com/s/MDHtNpKhBHM52HGhMqKKcw)
+ [Java 并发编程进阶：ReentrantLock 实现原理详解](https://mp.weixin.qq.com/s/rGI_ZJGs068aPbD0B3PBIQ)
+ [不只是“加锁”，它背后还有一整套锁升级机制(一文讲透 Java synchronized 关键字原理)](https://mp.weixin.qq.com/s/ucoAuAClcrPWxPvM1MB5cw)
+ [Java 锁底层原理：乐观锁、悲观锁、自旋锁、分布式锁，一网打尽](https://mp.weixin.qq.com/s/kt2fNppHxc8guEhND9_s7w)
...
+ [volatile关键字——面试官为什么总问它？](https://mp.weixin.qq.com/s/FyW4lF7MTeSaG1ant2SWKQ)
+ [Java 并发里最容易忽视的坑：volatile 不是你想的那样](https://mp.weixin.qq.com/s/xtUh8A6TpCcQbXVRZEq5BA)
+ [它不是轻量级锁，但确实很关键(一文讲透Java volatile关键字)](https://mp.weixin.qq.com/s/JKSEnJpYn4vMvumAQWoQQQ)
+ [五分钟背一个面试题：Java 的 volatile 关键字](https://mp.weixin.qq.com/s/bGoRXuEQ3GSzX6IkuDZ2cA)
+ [JMM 进阶：彻底理解 volatile 实现原理](https://mp.weixin.qq.com/s/PKtk5UYPCYUBImNsrmaTUA)
+ [[Java多线程][锁进阶]第17课：volatile——禁止指令重排](https://mp.weixin.qq.com/s/lcQSb2U6HZI-o3yQN6LdPw)
+ [7. 多线程(5) ---volatile关键字](https://mp.weixin.qq.com/s/ahjLqBVlRAp4Zk1F6j21oQ)
...
+ [JVM虚拟机-JVM调优工具](https://mp.weixin.qq.com/s/Fw60idKom0c-LIygP452tQ)
...
+ [面试官：什么是 AOT 编译？和 JIT 有什么区别？](https://mp.weixin.qq.com/s/_0wEnSifOx2JKbd8QqzDYA)
+ [一次真实的生产JVM故障排查：从CPU飚高到根因定位全流程](https://mp.weixin.qq.com/s/CIl_wYYUl3Nm1clwwQdw3Q)
+ [JIT编译黑盒：你的代码到底怎么跑的？](https://mp.weixin.qq.com/s/rZdNqn0xr4ASjLH_itCdnA)
+ [Java - 如何使用代码获取系统的瞬时CPU使用率和JVM的瞬时CPU使用率](https://mp.weixin.qq.com/s/c8hQQY5j12EPZjNhIrvKAg)
+ [五分钟背一个面试题：JVM 与性能调优](https://mp.weixin.qq.com/s/TPx1lzL9GeBGRsfjR8S6mA)
+ [JVM 运行时数据区：程序计数器、堆、虚拟机栈与栈帧](https://mp.weixin.qq.com/s/YnKgjc6pP7E1cjLFf32JWw)
+ [一个 Java 对象诞生前，JVM 要完成哪几步？（一文讲透 Java 对象创建过程）](https://mp.weixin.qq.com/s/VQFjpYJd9kuURh2CCXiXeg)
...
+ [-Xms到底要不要等于-Xmx？生产环境别再照抄](https://mp.weixin.qq.com/s/1XZWksiEX_vtm8zGtl0PUw)
+ [JVM参数详解基础篇](https://mp.weixin.qq.com/s/YYDpGLgwbRLB9nzYCdj6zw)
...
+ [JVM虚拟机-内存模型深度剖析](https://mp.weixin.qq.com/s/XowfiXQbuhkc9NBrWj8MMQ)
+ [JVM虚拟机-JVM对象创建与内存分配机制](https://mp.weixin.qq.com/s/QEQA79XRCLcE7ru25ce4mg)
+ [堆内存爆了，重启都没用：那次循环new对象引发的灾难](https://mp.weixin.qq.com/s/2_0OgV3a7vhevICMbnoC6Q)
+ [JVM 堆内存结构图（包含不同版本对比）](https://mp.weixin.qq.com/s/63U_ALu8bvhg36v5hhImFw)
+ [线上服务OOM溢出排查思路：从保留现场到精准定位](https://mp.weixin.qq.com/s/EhPxdx6KhkdtZcElBjrN2w)
...
+ [JVM 内存篇](https://mp.weixin.qq.com/s/4hziGIefIcHUXDNqu9Otzg)
+ [4C8G容器跑Java，JVM到底怎么配？一次搞懂内存分配、OOM风险与最佳实践](https://mp.weixin.qq.com/s/NtZuovThHN9_oJ8vaUzjFg)
+ [服务器内存泄漏排查：5步揪出OOM真凶](https://mp.weixin.qq.com/s/zMsY2SOBI1gT8VGLnMSX7g)
+ [Java 对象一定分配在堆上吗？（一文讲透JVM 逃逸分析与标量替换）](https://mp.weixin.qq.com/s/FSYCH94l7UKKKbBhcNPQFQ)
+ [[Java多线程][底层原理] 第59课：Java内存模型（JMM）图解](https://mp.weixin.qq.com/s/tbR_5XWUy9KXyy-BWLM54Q)
+ [一个对象从 new 到 Eden 的路](https://mp.weixin.qq.com/s/e5A92z2-TbnkGaw08aVm0A)
+ [线上OOM排查实录：从MAT dump分析到JVM参数调优的完整链路](https://mp.weixin.qq.com/s/WntD1W8tVbDRS5njnZ-tEA)
...
+ [类的加载_双亲委派&破坏双亲委派](https://mp.weixin.qq.com/s/cMjnI7sXJKPNhJr6fml3aA)
+ [JVM 类加载机制：从加载流程到双亲委派](https://mp.weixin.qq.com/s/uDST4mP9jUOyyj69vSZiVg)
+ [JVM 和类加载机制：为什么 .class 能真正跑起来](https://mp.weixin.qq.com/s/M65ORmGcdzPZgZuB-FnDGA)
+ [[Java多线程][底层原理] 第64课：类加载与线程安全](https://mp.weixin.qq.com/s/cknXrwfG7T4B1uRNA6uOrg)
+ [Java类加载器ClassLoader全解析：双亲委派、打破委派与热部署](https://mp.weixin.qq.com/s/-7SeSDxWK4pPsQy6z0Rtmg)
...
+ [CMS 为什么低停顿：边发货边盘点的代价](https://mp.weixin.qq.com/s/gFq80bnIya5lJOw6l6PmDg)
...
+ [G1深入理解系列-Young GC 不只是清 Eden](https://mp.weixin.qq.com/s/lbrgpDq_TGSf8kw5iJUp2Q)
...
+ [彻底根治ThreadLocal线上BUG！TTL完美解决线程池上下文泄漏、数据错乱问题](https://mp.weixin.qq.com/s/yPwnyw3aSMh12Evm4pC7hw)
+ [ThreadLocal中initialValue()的使用(操作同一个对象[引用])及原理](https://mp.weixin.qq.com/s/nG9w_BiaaePFpmAkFpMQKA)
...
+ [Java 的金额计算用 Long 还是 BigDecimal？](https://mp.weixin.qq.com/s/qGtbR-zRZJ8QZ0Hh7Scagw)

## util库

### Stream

+ [Java Stream流介绍及使用指南](https://mp.weixin.qq.com/s/41pbn8btI9zryhN3kDTYzw)
...
+ [《Effective Java》解读第 52 条：慎用重载](https://mp.weixin.qq.com/s/RrwPwqb9iVN7zPPoXcXBZg)
...
+ [没有终端操作，流水线就不开工？（一问讲透Java Stream API）](https://mp.weixin.qq.com/s/hkJUjlZd3lHIgeNvdMbXpA)
+ [Stream Gatherers:Stream API 在 JDK 22 之后终于补上的那块空白](https://mp.weixin.qq.com/s/k_InrLcF4nECpkJwhyWgZA)
+ [Java 开发 > 一行 Stream 抵十行 for 循环？这 4 个场景请慎用 ！](https://mp.weixin.qq.com/s/grap_nZcapKVd9M5x2-cPQ)
+ [Stream API 入门：声明式处理集合数据（AI 辅助学习 Java 8）](https://mp.weixin.qq.com/s/99KzszzV7Vaw2SGmDwdo5A)
+ [Stream 实战：博客列表排序、过滤与分页（AI 辅助学习 Java 8）](https://mp.weixin.qq.com/s/jr0l5zcPsPYyp89uy0RLOQ)
+ [flatMap 深入：一对多场景利器（AI 辅助学习 Java 8）](https://mp.weixin.qq.com/s/wuGdUvenw6eXgitS6PdxHw)
...
+ [Java集合全套解析|List、Set、Map底层原理与源码剖析](https://mp.weixin.qq.com/s/AgLMSEvKvOvKJJo_fN1qPQ)
...
+ [ArrayList 源码全解析：动态扩容、数组互转与底层原理](https://mp.weixin.qq.com/s/XJymsPIU5RVCJRsOyAbGEg)
+ [Java Collections 工具类：排序、查找、打乱一文搞定](https://mp.weixin.qq.com/s/OhYDT_l7be00Sp2LE9bK9g)
...
+ [HashMap在并发扩容中为什么容易导致链表成环，CPU飙升100%？](https://mp.weixin.qq.com/s/gU9GvN4Xo6t6PZMy-e0z2A)
...
+ [Optional 是什么？为什么能消灭 NullPointerException（AI 辅助学习 Java 8）](https://mp.weixin.qq.com/s/VdUD06pOpjmXIOKBbdQwyA)
...
+ [精通 Java 正则，少写千行代码](https://mp.weixin.qq.com/s/J8f2Y5BLCsxRsVRrSFhtNg)
...
+ [FutureTask 核心原理与实践解析](https://mp.weixin.qq.com/s/wjhdx_3-OO9Yqz-Y27LeIw)
...
+ [CompletableFuture进阶：组合、超时与线程池的那些坑](https://mp.weixin.qq.com/s/Vvqchp7cma5XIP9SwQcXBw)
+ [一个只能拿结果，一个能编排整条任务链(一文讲透Java Future与CompletableFuture)](https://mp.weixin.qq.com/s/EqErio468aVksC4sNRbDkg)
+ [[Java多线程][异步编程] 第49课：CompletableFuture基础用法](https://mp.weixin.qq.com/s/n_diJLnbT6PlrDRnS4unTQ)
+ [【Java踩坑笔记】24_CompletableFuture的默认线程池，生产环境慎用](https://mp.weixin.qq.com/s/kqewhdWtZYWKB8FsQrgvug)
+ [一个 CompletableFuture，把 CPU 打满了：默认线程池的线上坑](https://mp.weixin.qq.com/s/h19F5T6mh4BdthSah2r1tA)
+ [[Java多线程][异步编程] 第51课：CompletableFuture链式调用](https://mp.weixin.qq.com/s/hqz81k3Lj3u-Zq6TkwikAg)
+ [[Java多线程][异步编程] 第52课：CompletableFuture多路组合——allOf与anyOf](https://mp.weixin.qq.com/s/x6aDR4BpgPqxgjQfe7X3yA)
+ [[Java多线程][异步编程] 第53课：CompletableFuture异常处理](https://mp.weixin.qq.com/s/mifR0uvI7k4B2atolxk07Q)
+ [异步任务跑在哪，比怎么串更重要（一文讲透CompletableFuture 的执行器选择与 commonPool 隔离）](https://mp.weixin.qq.com/s/AvEiYqjoe5c1-e8-imFdLg)
+ [多数据源上下文在异步线程中不会自动传播：一次 CompletableFuture 排查记录](https://mp.weixin.qq.com/s/nRvJOiJ8Kl5by6gLWbsY6w)
+ [任务链不是把 then 连起来就完事了（一文讲透CompletableFuture 的串行、扁平化与并行组合）](https://mp.weixin.qq.com/s/oijWFk0WpgUwVI7nVA7O7w)
+ [微服务接口聚合调用，我用 AsyncTool 替代了 CompletableFuture](https://mp.weixin.qq.com/s/5ZZs44v6NoHX4aN6ooX60Q)
...
+ [[Java多线程][锁进阶] 第21课：StampedLock——乐观读](https://mp.weixin.qq.com/s/RTSz4v4Xc-MpfcHyV14PTA)
+ [并发 06 · Lock 家族](https://mp.weixin.qq.com/s/Uja06r4vZ0vfI2kLu3zdLA)
...
+ [Java 面试：ConcurrentHashMap 为什么线程安全？](https://mp.weixin.qq.com/s/GGF_O7zrPfCKInTEPIS70g)
+ [Java并发编程进阶：ConcurrentHashMap底层原理深度拆解](https://mp.weixin.qq.com/s/9zfsD6FAHFgHM9ZCSifWZg)
+ [[Java多线程][并发集合] 第36课：ConcurrentHashMap——分段锁原理](https://mp.weixin.qq.com/s/dJwhUi8HYZepa0Hy9CmswA)
+ [ConcurrentHashMap 线程安全实现原理 （JDK 7 vs JDK 8）](https://mp.weixin.qq.com/s/d2lCyI8LXZuBUolhLxbs8Q)
+ [ConcurrentHashMap size () 实现原理  ConcurrentHashMap 的 size() 方法：Java 7 vs Java 8 实现剖析](https://mp.weixin.qq.com/s/i-te_G5DzEjoA1X87GK_IA)
...
+ [Java并发编程进阶：Semaphore 原理与源码解析](https://mp.weixin.qq.com/s/P9HOK8Khgvnbja7GH9_rsg)
+ [看起来都在等，等的却不是一回事（一文讲透Java CountDownLatch、CyclicBarrier、Semaphore）](https://mp.weixin.qq.com/s/uBy_-E83PhDa-0dY5UKjcA)
+ [[Java多线程][并发集合] 第37课：ConcurrentLinkedQueue——无锁队列](https://mp.weixin.qq.com/s/CMRl1XkyLiJvpuk3X_wGcw)
+ [[Java多线程][并发集合] 第38课：ConcurrentSkipListMap——有序并发容器](https://mp.weixin.qq.com/s/huMQDAj_FsEAG051PfQk8w)
+ [[Java多线程][并发集合] 第40课：BlockingQueue——阻塞队列家族](https://mp.weixin.qq.com/s/h1S5ZSyR5ag8WhwetwFQNw)
+ [[Java多线程][并发工具] 第44课：Semaphore——控制并发数](https://mp.weixin.qq.com/s/TgApzcDLz32-gZmq-U9qtw)
+ [[Java多线程][并发工具] 第45课：Exchanger——线程间交换数据](https://mp.weixin.qq.com/s/loxofnYG6_4WeZRUoDqX0w)
+ [[Java多线程][并发工具] 第46课：Phaser——动态可复用的同步屏障](https://mp.weixin.qq.com/s/ET4kubZoKgnWKnUFeUs1ng)
+ [Java 最简单易用的3个线程同步工具类](https://mp.weixin.qq.com/s/bQ8nqANMsdGu3p_2-qsXhQ)
+ [CopyOnWriteArrayList实战心得：从性能拉胯到稳定运行](https://mp.weixin.qq.com/s/Iphm56F1rzCViSu_yn3J8Q)
...
+ [集合是如何传输的？（一问讲透 Java 集合序列化）](https://mp.weixin.qq.com/s/JKKzdcRQ4hie6SWwSgOWnA)
...
+ [Java利器：Pair和Triple无缝解决多值返回，编写高效代码！](https://mp.weixin.qq.com/s/b8USX9-WcGkdQjMJ8L8XuQ)
...
+ [我们放弃了Nacos作为配置中心，转而选择了这款神器~](https://mp.weixin.qq.com/s/t2I7iiaK7rBgPde1iFScEg)
...
+ [生产问题排查与性能瓶颈定位：日志、监控、链路追踪、压测与Arthas](https://mp.weixin.qq.com/s/lELdsmh4ccCox7lA0s-kdA)
+ [线上排查从3天变5分钟，Arthas这5个命令真香](https://mp.weixin.qq.com/s/VI_A0ww07EdJDe9AROnECQ)

## ByteBuddy

+ [线上紧急 Bug 怎么搞？基于 ByteBuddy 实现零重启，热修复](https://mp.weixin.qq.com/s/D3rEuV1nwxOR6z6RukUlkg)
...
+ [面试官问Dubbo支持分布式事务吗？90%程序员第一句就答错了！](https://mp.weixin.qq.com/s/4wrougtG9jjH6vTpTH9JfQ)
+ [为什么阿里偏爱 Dubbo，而互联网公司更爱 Spring Cloud？](https://mp.weixin.qq.com/s/yKqOMCNwHrwWcMpIBBwNtw)
+ [为什么大厂敢用Dubbo？看完它的安全设计你就懂了](https://mp.weixin.qq.com/s/Sp6bw4LXS4pn_CZLiyQ7Cw)
+ [面试官：Dubbo找不到服务怎么办？90%的人答不全](https://mp.weixin.qq.com/s/dCmvU9jvZ5AofZOyR_shag)
+ [为什么大厂都强调“快速失败”？Dubbo 超时机制告诉你答案！](https://mp.weixin.qq.com/s/NlkWYE5VIVxGHGWzV1AB3A)
+ [为什么大厂不敢随便删接口？一文讲透Dubbo兼容设计](https://mp.weixin.qq.com/s/sxebnqmXRXg-oe9JrJsw0A)
...
+ [Hutool DateUtil 虽爽，但高频场景请换回原生API！](https://mp.weixin.qq.com/s/Bk5hBkTKlKTFtX38KLTpkw)
+ [Hutool：Java 开发中的瑞士军刀——这 10 个方法你在用吗？](https://mp.weixin.qq.com/s/byvbNEu5j7-toXJ67A6uCg)
...
+ [原生 JDBC 性能差到想哭？阿里 Druid 才是正确答案](https://mp.weixin.qq.com/s/rXhW-kn-vT3-ZISUwRrDQA)
+ [做了 6 年 Java 开发，我为什么劝新人一定要学 JDBC](https://mp.weixin.qq.com/s/G31e95bLmLxSwiuXQgX6AQ)
+ [写 JDBC 总在复制粘贴？一个工具类帮你省一半代码](https://mp.weixin.qq.com/s/Lm-bUGYQSy6AJoMrHVN8-A)
...
+ [Apache Fory JSON或许可以替代FastJson](https://mp.weixin.qq.com/s/e0vekct5VcXPjSR3xQVrIg)
...
+ [吊打Fastjson1、Jackson！Fastjson2全方位升级实战指南](https://mp.weixin.qq.com/s/hDaHbx689YUDbjSApY0PxA)
...
+ [干掉BeanUtils！MapStruct完整版教程：原理、注解、自定义转换、性能、避坑](https://mp.weixin.qq.com/s/h2-lo0yJW6JwrvwrXDPJvA)

## mybatis

+ [MyBatis教程（Spring Boot最新版）](https://mp.weixin.qq.com/s/lxRRzbCkmpVvYgM78tnj3g)
...
+ [Step-06: SQL 执行器的定义和实现](https://mp.weixin.qq.com/s/Pk8W0mOmBQxJRksdtXy-jg)
+ [06手写Mybatis——执行器（Executor）架构实现](https://mp.weixin.qq.com/s/I9LLv9ynA9rfJ6jwXspp6A)
...
+ [自定义Mybatis的时间类型转换处理器](https://mp.weixin.qq.com/s/NBLY-WAMuqzcD4Za0asvcA)
+ [搞懂 MyBatis，数据库操作事半功倍](https://mp.weixin.qq.com/s/tUrVD5-rIDe51g9f_Iy_Qg)
+ [MyBatis 源码深度拆解（一）：整体架构 & 核心执行全流程](https://mp.weixin.qq.com/s/TGmHPaT5FD2DfIYti5EiYA)
+ [MyBatis 源码深度拆解（二）：核心配置加载原理](https://mp.weixin.qq.com/s/y3EDAJ5g65W73NQEt22HZA)
+ [MyBatis 源码深度拆解（三）：Mapper 接口动态代理底层原理](https://mp.weixin.qq.com/s/MYDbcNaa9j54860q5UV_ew)
+ [MyBatis 源码深度拆解（四）：SqlSession 体系深度拆解](https://mp.weixin.qq.com/s/bB39GV9C0NcbgzUZO17MNQ)
+ [MyBatis 源码深度拆解（五）：Executor 执行器设计与实现](https://mp.weixin.qq.com/s/J0wkewAYMTWzyEuqt69KyA)
+ [MyBatis 源码深度拆解（六）：#{} 与 ${} 底层解析 & SQL 预编译](https://mp.weixin.qq.com/s/owE2aXV58q1HABy-h3m4EQ)
...
+ [MyBatis 一级缓存默默开着，这个坑你踩过吗？](https://mp.weixin.qq.com/s/Sagv0GpeKc1Syrmak1CE5Q)
+ [面试官：说说 MyBatis 插件和缓存原理？从机制到实战，全给你讲透](https://mp.weixin.qq.com/s/8ZyJQ-T7_ehVd4LFTVQ1QA)
+ [MyBatis 能成为国内主流框架，核心杀手锏居然是这个？](https://mp.weixin.qq.com/s/wH_d8zSmM0lECejP8vLD1g)
+ [@EnumValue：比 TypeHandler 更优雅的枚举存储方案](https://mp.weixin.qq.com/s/HZ4XXoIsaaiRL90YiXt3Kw)
+ [Java 递归实现机构层级同步 | MyBatis级联查询树形数据](https://mp.weixin.qq.com/s/IbFTg32DPf2cFjxeU5r5Zw)
...
+ [别再只会用BaseMapper了：MyBatis-Plus藏着你该抄的工程设计哲学](https://mp.weixin.qq.com/s/BlgsuDLP-ZkL5zyPmnsmXg)
+ [做了 6 年 Java 后端，真心劝新人：别上来就学 MyBatis-Plus](https://mp.weixin.qq.com/s/gijRgaeqS-9nvNxE5mg-YA)
+ [MyBatisPlus封神玩法：这12个骚操作让开发效率直接起飞！](https://mp.weixin.qq.com/s/9wW6B-WR9T7y9a4R_RaDQQ)
+ [@Version 乐观锁：一篇讲透 MyBatis-Plus 的实现原理](https://mp.weixin.qq.com/s/s117MHFDcN-BaptVOQZ7jw)
+ [面试自测 | Mybatis-plus 全解析（核心剖析+误区自检）](https://mp.weixin.qq.com/s/r1deWwuo6rGVkQutAHqUiw)
+ [过来人真心话：别再手写 XML 了，MyBatis-Plus 才是后端摸鱼神器](https://mp.weixin.qq.com/s/Aiff5eeNQh_hJkhp5MT_aA)
...
+ [面试题：Nacos 是怎么在 Spring Boot 启动时把配置拿过来的？改了配置后，程序又是怎么自动刷新的？](https://mp.weixin.qq.com/s/xaCumy1GHcHggnsFeIBAtw)
...
+ [Nacos 注解全解析：7 个核心注解 + 5 个生产踩坑清单（2026 实测）](https://mp.weixin.qq.com/s/ajL8pDOER8psGopAQf2z9w)
+ [Nacos配置推送不一致，3个环境出了3种bug](https://mp.weixin.qq.com/s/umEctTEEFXnC2W2ItHi70w)
...
+ [Netty Reactor线程模型深度解析：EventLoop的“永动机”原理](https://mp.weixin.qq.com/s/0DlBCyu_JaRCxbm42BG18g)
...
+ [服务之间互相调用，经常随机超时！明明网络正常，Feign频繁Read timed out超时故障复盘](https://mp.weixin.qq.com/s/PcSXgFV9TTcfC4JNHf_Biw)
...
+ [基于Quartz的定时任务管理实现方案](https://mp.weixin.qq.com/s/cK5CbO4Uiwmsw11AyYa6Lw)
...
+ [Redisson 原理与最佳实践](https://mp.weixin.qq.com/s/bMRNQUCRfiMpGI8-oB9NVA)
+ [压测结束CPU依旧100%不降！深藏Redisson底层隐秘死循环Bug，90%团队都踩坑且无法感知](https://mp.weixin.qq.com/s/1PR3FHew1UoCfc3IEp-h5A)
+ [分布式锁用Redisson，这3个坑差点让库存超卖](https://mp.weixin.qq.com/s/yRqxwLXC0w3qEGmNtNy0EQ)
+ [Redisson 深度架构解析：别只把它当分布式锁工具](https://mp.weixin.qq.com/s/qD2CJ1T9xdfmyBtFItggiA)
+ [面试官：说说 Redisson 分布式锁的原理？从加锁到看门狗，全给你讲透](https://mp.weixin.qq.com/s/vVm7pv7MTqVmjAE0pQrqwA)
+ [Redisson源码解析，分布式锁解析](https://mp.weixin.qq.com/s/oqvM3g2oDfTXq9i1VDiomA)

## resilience4j

+ [绝了！Spring Boot 3 官方推荐的熔断器，原来是这个轻量级神兵利器](https://mp.weixin.qq.com/s/MbizgrldYXizad6QIpKk0g)
+ [别再用 Guava 限流了！Resilience4j RateLimiter 才是微服务限流王者](https://mp.weixin.qq.com/s/Y0jWHuG_kZUuHPLF6_puEA)
...
+ [对比 5 种分布式事务方案，还是宠幸了阿里的 Seata（原理 + 实战）](https://mp.weixin.qq.com/s/u2qiqNLkIzDPFj8t8-JmPA)
+ [【分布式事务】2、分布式事务Seata的应用与原理分析](https://mp.weixin.qq.com/s/7HSheSH59ISKpKmYQAXoMw)
+ [分布式事务Seata，这5个坑我全踩了](https://mp.weixin.qq.com/s/qBa0WT3hH-1Lg6oTygQZvw)
...
+ [Sentinel 限流原理详解：从 Slot Chain 到熔断降级一次讲透](https://mp.weixin.qq.com/s/KGKiY3zFqnvHBxojIcHWgA)
...
+ [2026年2月发布的Apache Shiro 2.1.0 深度拆解：轻量安全框架的现代化重生](https://mp.weixin.qq.com/s/LY9CZiGyXWVf1ZqDmJWz5Q)
...
+ [图解IOC控制反转：再也不用死记概念！](https://mp.weixin.qq.com/s/iwN4ljEY55TOfz5YN-yjCA)
+ [Spring中天天使用的这2个注解，你知道它们的区别吗？](https://mp.weixin.qq.com/s/N6zk9cyxvfhmbpv7Xq1m6g)
+ [02手写spring——Bean的定义、注册、获取](https://mp.weixin.qq.com/s/eCL8yY4AktgrseVbw1ZSAA)
+ [面试必问 Spring Bean 生命周期，我用办公室例子给你讲透了](https://mp.weixin.qq.com/s/IEzsRGcNbcB1l_DKOUvR5g)
+ [Spring & Spring Boot 常用注解详解：生命周期、懒加载、优先加载与实用技巧](https://mp.weixin.qq.com/s/Y5pF33UXMMgpPUeBMNJbDA)
+ [小白也能看懂的 Spring 注解：从 XML 到零配置全流程](https://mp.weixin.qq.com/s/WtP5it5SNUtNplgV4g3DJw)
+ [IoC 与 DI 核心概念](https://mp.weixin.qq.com/s/g8t3sAV0bJECviPeL1_7Gg)
+ [@Component单例类时间固定不刷新问题说明](https://mp.weixin.qq.com/s/89cydp24BUe-cuIRMrjr2Q)
+ [Spring Bean生命周期，我只答了"创建→初始化→销毁"](https://mp.weixin.qq.com/s/jowArF4Z2fGx-rRl8JmwDw)
...
+ [05手写spring——从手动注册到 XML 配置，容器开始读懂配置文件](https://mp.weixin.qq.com/s/2JVDCZuH0VMV5i5VdaKoiA)
...
+ [03手写spring——让Bean支持构造参数实例化](https://mp.weixin.qq.com/s/w7Udo-q_TiFSEq-Yoxgphw)
+ [04手写spring——让 Bean 拥有属性和依赖](https://mp.weixin.qq.com/s/O0T0e-ivjdS1F-0KcntbTA)
+ [07手写spring——Bean的初始化与销毁](https://mp.weixin.qq.com/s/awQH7AHQUQt2TLXj0bKAKg)
...
+ [Spring循环依赖：源码级深度拆解——三级缓存、构造器注入与规避方案](https://mp.weixin.qq.com/s/vbWV6eCSYteZvm3O3EPrkw)
+ [十万个why：明明 Spring 二级缓存就能解决循环依赖，为什么非弄个三级缓存？](https://mp.weixin.qq.com/s/0k9u31SjPfZXtiRIs0YHOA)
...
+ [拦截器拿不到请求报文，接口却能正常接收参数！RequestBody读取一次就清空，线上鉴权失效故障复盘](https://mp.weixin.qq.com/s/mqOR_rOnvWKoR5Rjx0vkDA)
+ [面试官：SpringBoot里面会有一些注解，比如@Controller，这个是做什么用的？@Service呢？](https://mp.weixin.qq.com/s/tRoQvOq72mnYHrf1FN9aMg)
+ [线程变量使用全攻略：为什么、何时、怎么用，这一篇就够了！](https://mp.weixin.qq.com/s/Vp2BRaOT3NWfxGtecUrQ1A)
+ [面试官问我SpringMVC流程，我用快递分拣讲明白了](https://mp.weixin.qq.com/s/380yOKvuopQNLnFY1qYIYg)
+ [@Valid+@Validated参数校验，分组校验实战](https://mp.weixin.qq.com/s/uCCLjlSK5qT6Zcw2Ic4K5w)
...
+ [甩掉 Swagger UI！SpringBoot API 文档神器强势登场](https://mp.weixin.qq.com/s/BT8-lSfw0qaOMZK9S24tJA)
...
+ [Spring Task定时任务：3行代码解放双手，告别重复劳动！](https://mp.weixin.qq.com/s/zP8g7Vtrc1H3RfAb4lEfPQ)
+ [非常危险！不会你还在用@Async吧](https://mp.weixin.qq.com/s/IlNSRAEaCrf8S09pKe_n7A)
+ [Spring 中实现异步调用的常见方式](https://mp.weixin.qq.com/s/I1mHnpUNIPlWc3pl7scTAQ)
...
+ [Spring 中处理异步的 4 个注解：一个订单接口的进化史](https://mp.weixin.qq.com/s/QPn382g0lfbREC7tNe-Qrw)
...
+ [JWT 认证与 Spring Security 集成](https://mp.weixin.qq.com/s/0u9QkeIAJI03ZmKcGTLxrw)
...
+ [面试官：为什么@Transactional会失效？我直接把他问沉默了](https://mp.weixin.qq.com/s/DCqdEhiGOJpOR_jex_TxTw)
...
+ [Spring 事务管理基础](https://mp.weixin.qq.com/s/_0d1NXdoYeA16zJewXutbw)
+ [@Transactional 加了，数据还是没回滚？这两个坑我帮你踩过了](https://mp.weixin.qq.com/s/tmHDpZyr7c-eiTp81BBoKQ)
+ [为啥加个 @Transactional 就能自动回滚？底层终于搞懂了](https://mp.weixin.qq.com/s/8KaywNIV0w26hZZJBRoFTA)
+ [为什么你的 @Transactional 总是不生效？原因多半在这 3 点](https://mp.weixin.qq.com/s/DvRFFWCl7suykNG6BI8_Bg)
...
+ [一文搞懂结构型设计模式四大天王：代理、装饰器、适配器、外观，附 Spring 源码实战](https://mp.weixin.qq.com/s/Brk0eM7ZmEM83-JYAEn6nA)
...
+ [Spring集成redis缓存功能](https://mp.weixin.qq.com/s/HGI12ArbYJyxhDHnbyuB1w)
+ [数据库已经新增成功，接口一直查不到数据！SpringCache 默认缓存 Null 值，导致永久脏数据穿透故障复盘](https://mp.weixin.qq.com/s/1wYIrYhJq8VQYfjaMCMzRA)
+ [Spring 高性能多级缓存全攻略：Caffeine + Redis 的生产级设计、实现与治理实践](https://mp.weixin.qq.com/s/gZormoMOP8hRXhFB2prhqQ)
+ [Spring Cache 缓存注解：@Cacheable / @CachePut / @CacheEvict / @CacheConfig，一个商品详情接口的缓存进化史](https://mp.weixin.qq.com/s/eH1ZUZKl5XwhHVxJzEEMJg)
...
+ [Spring AOP与事务管理深入解析](https://mp.weixin.qq.com/s/OOWIaJ1jHqY8-wbw_mldYA)
...
+ [Spring Modulith 2.1来了：当微服务“降温”，模块化单体开始回归理性](https://mp.weixin.qq.com/s/d2NwiCDRpfqZE9UrBadrHg)
...
+ [Spring Cloud核心组件](https://mp.weixin.qq.com/s/f84QKpfiVWSNbCmVuXMQYQ)
...
+ [SpringBoot 控制台秒变炫彩特效，秀翻同事指南！](https://mp.weixin.qq.com/s/N6XkVPHRN2-kqC_0ta4msw)
+ [SpringBoot 中常用的工具类库及其使用示例（完整版）](https://mp.weixin.qq.com/s/Le980yts2IUhoZqATUoL_w)
+ [SpringBoot 中常用的工具类库及其使用示例](https://mp.weixin.qq.com/s/9cVJuk4jPTBLM6HhGbsibg)
+ [SpringBoot中常用的工具类库及其使用示例](https://mp.weixin.qq.com/s/ZbbyebICfR8TFnozBFPsLg)
+ [9个实用Spring Boot实战技巧](https://mp.weixin.qq.com/s/ueu859Ytg1mCAHH_aW8PBg)
+ [优雅且强大！解锁 Spring Boot 全局异常处理新玩法](https://mp.weixin.qq.com/s/ZZCCIUgUu-lkkE4e8m3niA)
+ [实体到DTO转换：4种方式，别用错了性能差3倍](https://mp.weixin.qq.com/s/7ytmB1hsZGHeAW_9cLa_Cg)
...
+ [别再满屏 @Qualifier 了！Spring 多实现注入的 2 个高级套路](https://mp.weixin.qq.com/s/5SrAET8rQW_DB7PS2xxQyg)
+ [Spring Boot 开发 > 全局异常处理——别再到处 try-catch](https://mp.weixin.qq.com/s/Qhf1hUtTd0k9IvNel-GgyQ)
+ [告别 XML 配置，Spring Boot 快速开发入门](https://mp.weixin.qq.com/s/KwHNU8B-BwCh-S2bF8CTsg)
+ [Spring Boot 项目越写越乱？问题通常出在这 8 个地方](https://mp.weixin.qq.com/s/T_us1N4yCIBXaJwEe6m0Fg)
+ [【高频面试题】SpringBoot自动配置原理](https://mp.weixin.qq.com/s/X9k9KYbi0zYTykDQj0TZGQ)
...
+ [牛啊~ Spring Boot 实现代码更新不停机！](https://mp.weixin.qq.com/s/ToKt_blfbyLWY6VTg8XRmA)
...
+ [Spring Boot 3.4.x 必知：@Bean 使用defaultCandidate = false](https://mp.weixin.qq.com/s/zbcRwuvXeVK-XGMTYBZCtg)
...
+ [Spring Boot 4 正式发版啦！核心功能速览](https://mp.weixin.qq.com/s/ZaXGcGXk3g_mIzk9yDLAhw)
+ [变天了，Spring Boot 4 震撼发布！性能提升40%](https://mp.weixin.qq.com/s/-53SIuw7z6jWM5hsXxYfjg)
...
+ [升级 SpringBoot 4.0 后缓存集体失灵：一个 SpringBoot 4.0 埋的静默炸弹](https://mp.weixin.qq.com/s/ww6YneLCrfwAFdOpPut1bA)
+ [Spring Boot 4.1实战：像写REST接口一样写gRPC](https://mp.weixin.qq.com/s/w5zZNUlUqsvmFVZW_fQ03g)
+ [Spring Boot 4.1版本正式发布，20个新功能及亮点](https://mp.weixin.qq.com/s/XTcDp9hCxM8MgL5u26p-NA)
+ [被SpringBoot3强制要求JDK17整破防了？别只盯着Record，这三个底层迁移坑才真要命](https://mp.weixin.qq.com/s/Tw_2JqPECKOQXWOSB0A5NQ)
...
+ [14 个真实场景！Spring Boot 分布式缓存的核心问题](https://mp.weixin.qq.com/s/IDGMMQBPHMnNnpk4v4jV2A)
...
+ [SpringBoot 最大连接数及最大并发数是多少？？？](https://mp.weixin.qq.com/s/wqrtaxeMjk0mtd5lypGwYQ)
...
+ [Spring Boot中JSON日期处理的5种骚操作](https://mp.weixin.qq.com/s/Q1Bal2UuNnY4zhmx0zaL0w)
+ [太强了！Spring Boot 百万级Excel读写仅需5秒，这波操作封神！](https://mp.weixin.qq.com/s/tU643EGK5W1xBv0bFKWsUA)
+ [一个接口，N 种实现？Spring Boot 中的10种切换方式](https://mp.weixin.qq.com/s/VAmjzmSuG5i8gSiX40rh7Q)
+ [告别JSON字段适配噩梦，Spring Boot优雅方案来袭](https://mp.weixin.qq.com/s/lhalkUpsEuLH3D23budnnA)
...
+ [Spring Boot 接口敏感字段脱敏的5大"王炸"方案](https://mp.weixin.qq.com/s/HQEHUrJLsw37aUKPyRTCDw)
...
+ [零侵入插件！Spring Boot 一键生成 8种格式API接口文档](https://mp.weixin.qq.com/s/B9pyyMlbODhm5B1SzfDwPQ)
...
+ [最简单方式！一个注解搞定 Spring Boot 动态字段输出](https://mp.weixin.qq.com/s/K_pNCxw1y5tEkSoZLlGE0g)
+ [SpringBoot 工厂+策略模式，实现统一多端登录！](https://mp.weixin.qq.com/s/Kmkhr2UQgANynbmDpgDnkA)
...
+ [Spring Boot + Jackson 组合注解：一行代码终结 90% 样板代码](https://mp.weixin.qq.com/s/9wY1OOr1KL5L2FCS4tEMRQ)
+ [手搓了一个 SpringBoot 接口防护神器（防重+限流）](https://mp.weixin.qq.com/s/QjmjmF440IH2tgHUwA5eQQ)
+ [手搓了一个 SpringBoot 接口防护神器（防重+限流）](https://mp.weixin.qq.com/s/b923RFKufDpI0g8dojB2TQ)
+ [Entity 转 DTO 哪种方式最快？3 种映射方案性能实测大揭秘！](https://mp.weixin.qq.com/s/FeqFtkdxOMsjaC4xgxbFxw)
+ [深入底层！Spring Boot 默认错误处理的3种机制](https://mp.weixin.qq.com/s/xj4s204SnFokMb0hFsg-vA)
...
+ [springboot：应用授权使用方案](https://mp.weixin.qq.com/s/_xRptWVBz_jfvv2LMcgHWA)
+ [SpringBoot文件上传大小限制解决方案](https://mp.weixin.qq.com/s/5ZqmXJqzzYpm9Ts9XXjvUA)
+ [还在自己写？Spring Boot内置并发限流工具为什么不用？](https://mp.weixin.qq.com/s/d15I32hj6E-3a6Vqvs4b6w)
...
+ [Controller接口添加统一前缀的7种方式](https://mp.weixin.qq.com/s/IUMMciWVWllq5Wfy6jhUcA)
+ [GB 级文件上传，Spring Boot 就该这么做](https://mp.weixin.qq.com/s/cpWe-K-5spbUNcmNCXvU_A)
+ [Spring Boot 中 Filter、Interceptor、AOP 到底谁先执行？](https://mp.weixin.qq.com/s/q9pPsakxB5uMWXaSPbNktg)
+ [Spring Boot 内置 Filter：处理特殊URL](https://mp.weixin.qq.com/s/9c00ojA7kfrL_0DWC3ud-A)
+ [Spring Boot 聚合API查询，3种方式性能对比（虚拟线程+结构化并发，CompletableFuture）](https://mp.weixin.qq.com/s/uvMJHqm47stjhdjOP1u77A)
+ [优雅！Spring Boot 持久化 JSON数据的4种实现方式](https://mp.weixin.qq.com/s/dNEXnC6igFUN_wjnv4JiqQ)
+ [Spring Boot 开发 > 查询参数、请求体、数据库 —— 枚举 Enum 在三个层的正确处理姿势](https://mp.weixin.qq.com/s/NeWAQfI6L3v5Gzbu0BlGqQ)
+ [SpringBoot3项目中 字典翻译 + 枚举翻译 + 敏感数据脱敏：三个"不起眼"的基础模块如何让开发效率翻倍](https://mp.weixin.qq.com/s/sfFZfhl2GzITUMAD9MhDWA)
...
+ [实时通信！Spring Boot+WebSocket 多端会话、私聊与广播实战](https://mp.weixin.qq.com/s/9bl9LyzQKGRr_LplNV2cpQ)
...
+ [海量数据下，Spring Boot 为什么推荐 Slice，而不是 Page？](https://mp.weixin.qq.com/s/q0jCjaGWKIvYMZKDLB9eLA)
+ [5分钟落地！Redis Pub/Sub：基于 Spring Boot 的极简消息引擎](https://mp.weixin.qq.com/s/A5JU6zZAZ3xL2ctd9zViCw)
...
+ [Java并发性能调优！5个让性能提升300%的高级调优技巧](https://mp.weixin.qq.com/s/78kh2lcLxuXZmfBjNx69BQ)
+ [求求你，别再乱用 @Async 了！高级开发的 4 种异步军规](https://mp.weixin.qq.com/s/NP0VnxHKCR9aMQBugTb_Ww)
+ [SpringBoot 常用的线程安全工具类 - PriorityBlockingQueue 解剖](https://mp.weixin.qq.com/s/2EXQKKACVwjUqsQxz68RhA)
+ [SpringBoot中@Scheduled多线程并发隐患与解决方案](https://mp.weixin.qq.com/s/TA2ZLebChuc1SX6DPntglA)
+ [SpringBoot 异步处理：@Async 与线程池配置](https://mp.weixin.qq.com/s/eL430AoxhK3q7tL61e156A)
+ [SpringBoot 消费者并发控制：线程池配置](https://mp.weixin.qq.com/s/9MKXYXxegOaO_f-9ooCLDA)
+ [SpringBoot 定时任务](https://mp.weixin.qq.com/s/Wdt1aIGmnga1RrWvuno8Aw)
...
+ [Java开发：不止@EventListener！Spring Boot事件机制深度解析，吃透业务解耦核心技巧](https://mp.weixin.qq.com/s/S1w14OJtK6ZC9jZcR2JWmQ)
+ [SpringBoot 事件发布机制：原理篇](https://mp.weixin.qq.com/s/ZfQqyYHhvfJR7C8byZ7tGQ)
...
+ [SpringBoot 缓存注解：@Cacheable/@CacheEvict 使用](https://mp.weixin.qq.com/s/DZIkOf9hnVECg5ifNfHavQ)
+ [SpringBoot 缓存穿透/击穿/雪崩解决方案](https://mp.weixin.qq.com/s/Xkv3dBlXTpqGpGDn0wtRBw)
...
+ [告别@Bean注解！Spring Boot内置SPI机制实现零侵入扩展](https://mp.weixin.qq.com/s/XzOp_TRTW6qATbWFkMUYAA)
+ [Java SPI与Spring SPI对比，Spring为何不用原生SPI？](https://mp.weixin.qq.com/s/A_0Uis9VbGOVwuaipjZpJA)
...
+ [Spring Boot 打包方式全攻略：不是只有 jar 和 war，7 种姿势你选哪个？](https://mp.weixin.qq.com/s/Ek7EEVTOKkHJ4TpxcP_V3w)
...
+ [SpringBoot3.2 + jdk21 + GraalVM上手体验](https://mp.weixin.qq.com/s/ox-UR05tGPuvgooZBe5snA)
...
+ [一个注解实现 WebSocket 集群方案，这样玩才爽！](https://mp.weixin.qq.com/s/VPpO0r4G7bWe-3XeJYUqug)
+ [查询优化！Spring Boot + Lucene 构建全文检索](https://mp.weixin.qq.com/s/EOhmcAdko3AxtsrDdSauKw)
...
+ [SpringBoot+Tess4j:轻松实现OCR功能](https://mp.weixin.qq.com/s/nBBCZG5O-nT8sG6vZlQ1mw)
...
+ [JAVA：Spring Boot3 集成 JAXB + XSD 进行 XML 校验](https://mp.weixin.qq.com/s/FQUF5yBmU5I6_f4_RgB0Vw)
...
+ [Servlet 的三宗罪：Spring 的崛起,可能就是被它逼出来的](https://mp.weixin.qq.com/s/DXiKw8LSHwG0ZhJo_DwA2w)
+ [Servlet生命周期和配置](https://mp.weixin.qq.com/s/Qx24jAX0SWAvZ-GYBRZrwQ)
...
+ [扔掉笨重的XXL-JOB？试试这个基于Nacos的优雅调度方案](https://mp.weixin.qq.com/s/MVhqJEZoSdmNXb667dA77Q)
+ [XXL-JOB 执行器掉线排查实录：从踩坑到上岸](https://mp.weixin.qq.com/s/RUGjpSZyIVPFRM0bq3f91Q)
...
+ [@AutoClose 注解来袭！资源清理不再愁](https://mp.weixin.qq.com/s/CzPhgjkNvGPY7PTf54w9XA)
...
+ [百万级任务重试框架 Fast-Retry, 太香了！](https://mp.weixin.qq.com/s/vCOalIbb1rqAIonl9kx31A)
...
+ [分布式锁用起来太麻烦，那就自己封装一下，简化使用~](https://mp.weixin.qq.com/s/09pKeRTSJZVJsr4edaD6Ww)
...
+ [项目终于用上了 PowerJob，睡觉真香！](https://mp.weixin.qq.com/s/uqxvIasqGeZcGvyeOmwcPg)
...
+ [从99%占用降到65%：30GB服务器内存被Java吃光的优化实战](https://mp.weixin.qq.com/s/3SXoPEGtTmXRHUK-BY77ew)
+ [Java实现秒传](https://mp.weixin.qq.com/s/Xm4zKq-mRH32t513LZzzpw)
...
+ [Java 微服务性能现在能追上 Go 了吗？](https://mp.weixin.qq.com/s/i6IPnE-OO5HvsOvwiGxq9g)
